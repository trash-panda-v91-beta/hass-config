 ...
 */class rt extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let o=s._$litPart$;if(void 0===o){const t=i?.renderBefore??null;s._$litPart$=o=new X(e.insertBefore(R(),t),t,void 0,i??{})}return o._$AI(t),o})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return z}}rt._$litElement$=!0,rt.finalized=!0,nt.litElementHydrateSupport?.({LitElement:rt});var at,lt;(0,nt.litElementPolyfillSupport)?.({LitElement:rt}),(nt.litElementVersions??=[]).push("4.2.1"),function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(at||(at={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(lt||(lt={}));var dt=function(t,e,i){void 0===i&&(i=!1),i?history.replaceState(null,"",e):history.pushState(null,"",e),function(t,e,i,s){s=s||{},i=null==i?{}:i;var o=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});o.detail=i,t.dispatchEvent(o)}(window,"location-changed",{replace:i})},ct={version:"Version",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_error:"Show Error"},ht={production:"Production",consumption:"Consumption",yield_today:"Yield today",grid_today:"Grid today",battery:"Battery",inverter_state:"Inverter state",total_yield:"Total yield",grid_consumption:"Grid consumption",battery_capacity:"Battery capacity",inverter_mode:"Inverter mode",weather_today:"Weather today",solar_forecast:"Solar forecast",expected_forecast:"Expected forecast"},ut={common:ct,card:ht},pt={production:"Producción",consumption:"Consumo",yield_today:"Producción hoy",grid_today:"Red hoy",battery:"Batería",inverter_state:"Estado del inversor",total_yield:"Producción total",grid_consumption:"Consumo de red",battery_capacity:"Capacidad de la batería",inverter_mode:"Modo del inversor",weather_today:"Tiempo hoy",solar_forecast:"Pronóstico solar",expected_forecast:"Pronóstico esperado"},_t={card:pt},vt={production:"Production",consumption:"Consommation",yield_today:"Production aujourd'hui",grid_today:"Réseau aujourd'hui",battery:"Batterie",inverter_state:"État de l'onduleur",total_yield:"Production totale",grid_consumption:"Consommation réseau",battery_capacity:"Capacité de la batterie",inverter_mode:"Mode de l'onduleur",weather_today:"Météo aujourd'hui",solar_forecast:"Prévision solaire",expected_forecast:"Prévision attendue"},mt={card:vt},yt={production:"Erzeugung",consumption:"Verbrauch",yield_today:"Erzeugung heute",grid_today:"Netz heute",battery:"Batterie",inverter_state:"Wechselrichterstatus",total_yield:"Gesamterzeugung",grid_consumption:"Netzverbrauch",battery_capacity:"Batteriekapazität",inverter_mode:"Wechselrichtermodus",weather_today:"Wetter heute",solar_forecast:"Solarvorhersage",expected_forecast:"Erwartete Vorhersage"},gt={card:yt},ft={production:"Produção",consumption:"Consumo",yield_today:"Produção hoje",grid_today:"Rede hoje",battery:"Bateria",inverter_state:"Estado do inversor",total_yield:"Produção total",grid_consumption:"Consumo da rede",battery_capacity:"Capacidade da bateria",inverter_mode:"Modo do inversor",weather_today:"Tempo hoje",solar_forecast:"Previsão solar",expected_forecast:"Previsão esperada"},wt={card:ft},$t={production:"Productie",consumption:"Verbruik",yield_today:"Opbrengst vandaag",grid_today:"Net vandaag",battery:"Batterij",inverter_state:"Status omvormer",total_yield:"Totale opbrengst",grid_consumption:"Netverbruik",battery_capacity:"Batterijcapaciteit",inverter_mode:"Omvormermodus",weather_today:"Weer vandaag",solar_forecast:"Zonneprognose",expected_forecast:"Verwachte prognose"},bt={card:$t};const xt={en:Object.freeze({__proto__:null,card:ht,common:ct,default:ut}),es:Object.freeze({__proto__:null,card:pt,default:_t}),fr:Object.freeze({__proto__:null,card:vt,default:mt}),de:Object.freeze({__proto__:null,card:yt,default:gt}),pt:Object.freeze({__proto__:null,card:ft,default:wt}),nl:Object.freeze({__proto__:null,card:$t,default:bt})};function At(t,e="",i=""){var s,o,n;let r="en";try{const t=document.querySelector("home-assistant")||document.querySelector("hc-main")||document.querySelector("home-assistant-main"),e=null==t?void 0:t.hass;r=(null===(s=null==e?void 0:e.locale)||void 0===s?void 0:s.language)||(null==e?void 0:e.language)||(null===(o=document.documentElement)||void 0===o?void 0:o.lang)||navigator.language||"en"}catch(t){r=(null===(n=document.documentElement)||void 0===n?void 0:n.lang)||navigator.language||"en"}const a=String(r).replace(/['"]+/g,"").replace("-","_"),l=a.split("_")[0],d=xt[a]||xt[l]||xt.en;let c;try{c=t.split(".").reduce(((t,e)=>null==t?void 0:t[e]),d)}catch(t){c=void 0}return void 0===c&&(c=t.split(".").reduce(((t,e)=>null==t?void 0:t[e]),xt.en)),"string"!=typeof c&&(c=t),""!==e&&""!==i&&(c=c.replace(e,i)),c}class Et extends rt{static get properties(){return{_hass:{attribute:!1},config:{attribute:!1}}}constructor(){super(),this._valueChanged=t=>{t.stopPropagation();const e=Object.assign(Object.assign({},this.config),t.detail.value);this.config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))},this._computeLabel=t=>({production_entity:"PV production entity (W / kW)",current_consumption_entity:"Current consumption entity (W / kW)",show_energy_flow:"Show Energy Flow (built-in)",show_top_devices:"Show top devices row",top_devices_max:"Max device badges (1–8)",show_solar_forecast:"Show solar forecast panel",weather_entity:"Weather entity (optional)",solar_forecast_today_entity:"Solar forecast today entity (kWh, optional)",yield_today_entity:"Yield today entity (kWh)",grid_consumption_today_entity:"Grid consumption today entity (kWh)",battery_percentage_entity:"Battery percentage entity (%)",inverter_state_entity:"Inverter state entity (text)",total_yield_entity:"Total yield entity (kWh)",total_grid_consumption_entity:"Total grid consumption entity (kWh)",battery_capacity_entity:"Battery capacity entity (kWh)",inverter_mode_entity:"Inverter mode entity (text sensor)",image_url:"Image URL (optional)",trend_graph_entities:"Trend graph entities (multiple sensors)",trend_graph_hours_to_show:"Trend graph hours (default 24)"}[t.name]||t.name),this._computeHelper=t=>({yield_today_entity:"Optional. Leave empty to compute from 'Total yield' using today's history (00:00 → now).",grid_consumption_today_entity:"Optional. Leave empty to compute from 'Total grid consumption' using today's history (00:00 → now).",show_energy_flow:"Adds the built-in Energy Flow (Sankey) graph below this card (requires Energy configuration).",show_top_devices:"Adds a single-row list of top-consuming devices from Energy preferences (requires Energy configuration).",top_devices_max:"Number of top-consuming device badges to display",show_solar_forecast:"Shows a compact forecast panel aligned to the right.",weather_entity:"If set, shows temperature and condition for today.",solar_forecast_today_entity:"If set and no weather entity, shows today's expected solar production.",trend_graph_entities:"Optional. Select one or more sensor entities to render as individual trend graphs (Tile features).",trend_graph_hours_to_show:"Optional. Applies to all auto-generated trend graphs."}[t.name]),this.config={type:"custom:solar-card"},this._hass=null}set hass(t){this._hass=t,this.requestUpdate()}get hass(){return this._hass}setConfig(t){this.config=t||{},this.requestUpdate()}_buildSchemas(){const t=this.config||{};return{overview:[{name:"production_entity",required:!0,selector:{entity:{domain:"sensor",device_class:"power"}}},{name:"current_consumption_entity",required:!0,selector:{entity:{domain:"sensor",device_class:"power"}}},{name:"image_url",selector:{text:{}}}],today:[{name:"yield_today_entity",selector:{entity:{domain:"sensor",device_class:"energy"}}},{name:"grid_consumption_today_entity",selector:{entity:{domain:"sensor",device_class:"energy"}}},{name:"battery_percentage_entity",selector:{entity:{domain:"sensor",device_class:"battery"}}},{name:"inverter_state_entity",selector:{entity:{domain:"sensor"}}}],totals:[{name:"total_yield_entity",selector:{entity:{domain:"sensor",device_class:"energy"}}},{name:"total_grid_consumption_entity",selector:{entity:{domain:"sensor",device_class:"energy"}}},{name:"battery_capacity_entity",selector:{entity:{domain:"sensor"}}},{name:"inverter_mode_entity",selector:{entity:{domain:"sensor"}}}],weatherToggle:[{name:"show_solar_forecast",selector:{boolean:{}}}],weatherOptions:!!t.show_solar_forecast?[{name:"weather_entity",selector:{entity:{domain:"weather"}}},{name:"solar_forecast_today_entity",selector:{entity:{domain:"sensor",device_class:"energy"}}}]:[],topDevicesToggle:[{name:"show_top_devices",selector:{boolean:{}}}],topDevicesOptions:!!t.show_top_devices?[{name:"top_devices_max",selector:{number:{min:1,max:8,mode:"box"}}}]:[],trend:[{name:"trend_graph_entities",selector:{entity:{multiple:!0,domain:"sensor"}}},{name:"trend_graph_hours_to_show",selector:{number:{min:1,max:168,mode:"box"}}}],sankey:[{name:"show_energy_flow",selector:{boolean:{}}}]}}render(){const t=this._buildSchemas();return I`
      <div class="editor">
        ...
        <div class="section">
          ...
          <ha-form
            .hass=${this._hass}
            .data=${this.config}
            .schema=${t.weatherToggle}
            .computeLabel=${this._computeLabel}
            .computeHelper=${this._computeHelper}
            @value-changed=${this._valueChanged}
          ></ha-form>
          ${t.weatherOptions.length?I`<div class="dependent">
                <ha-form
                  .hass=${this._hass}
                  .data=${this.config}
                  .schema=${t.weatherOptions}
                  .computeLabel=${this._computeLabel}
                  .computeHelper=${this._computeHelper}
                  @value-changed=${this._valueChanged}
                ></ha-form>
        ...
        <div class="section">
          ...
          <ha-form
            .hass=${this._hass}
            .data=${this.config}
            .schema=${t.topDevicesToggle}
            .computeLabel=${this._computeLabel}
            .computeHelper=${this._computeHelper}
            @value-changed=${this._valueChanged}
          ></ha-form>
          ${t.topDevicesOptions.length?I`<div class="dependent">
                <ha-form
                  .hass=${this._hass}
                  .data=${this.config}
                  .schema=${t.topDevicesOptions}
                  .computeLabel=${this._computeLabel}
                  .computeHelper=${this._computeHelper}
                  @value-changed=${this._valueChanged}
                ></ha-form>
  ...
  `,customElements.define("solar-card-editor",Et),window.customCards=window.customCards||[],window.customCards.push({type:"solar-card",name:"Solar Energy Card",description:"Left panel: yield today, current consumption, title, and image.",preview:!0,documentationURL:"https://github.com/victorigualada/lovelace-solar-card"});const Ct=new Set(["unknown","unavailable","none"]);function St(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Tt(t,e,i={}){var s;if(null==t||""===t)return"—";const o=Number(t);if(Number.isNaN(o))return String(t);const n=(null===(s=null==e?void 0:e.locale)||void 0===s?void 0:s.language)||(null==e?void 0:e.language)||navigator.language||"en";try{return new Intl.NumberFormat(n,i).format(o)}catch(t){return String(o)}}function Pt(t,e){var i;if(!e)return{value:"—",unit:""};const s=null===(i=null==t?void 0:t.states)||void 0===i?void 0:i[e];if(!s)return{value:"—",unit:""};const o=s.attributes.unit_of_measurement||"",n=s.state;if(Ct.has(n))return{value:"—",unit:o};return{value:Tt(n,t,{maximumFractionDigits:2}),unit:o}}class Rt extends rt{static get properties(){return{_hass:{attribute:!1},_config:{attribute:!1},_deviceBadges:{attribute:!1}}}constructor(){super(),this._onDevicesClick=t=>{var e,i,s;const o=t.composedPath?t.composedPath().find((t=>{var e,i;return null===(i=null===(e=null==t?void 0:t.classList)||void 0===e?void 0:e.contains)||void 0===i?void 0:i.call(e,"badge")})):null===(i=(e=t.target).closest)||void 0===i?void 0:i.call(e,".badge"),n=null===(s=null==o?void 0:o.getAttribute)||void 0===s?void 0:s.call(o,"data-stat-id");n&&this._openBadgeDevice(n)},this._config={type:"custom:solar-card"},this._hass=null,this._gridTodayCache={key:null,dateKey:null,result:null,inflight:!1},this._yieldTodayCache={key:null,dateKey:null,result:null,inflight:!1},this._energyFlowEl=null,this._gridKwhEl=null,this._trendGraphEls=null,this._trendGraphsSig=null,this._deviceBadges=[],this._devicesRefreshing=!1,this._devicesLastFetch=0,this._devicesTimer=null,this._entityRegistry=null,this._deviceRegistry=null,this._devicePowerMap=null,this._deviceList=[],this._deviceIconById=null,this._entityRegistryByEntityId=null,this._lastLang=null}setConfig(t){var e,i,s,o,n,r,a,l,d,c,h,u,p,_,v,m,y,g;const f=Object.assign({production_entity:null!==(i=null!==(e=t.production_entity)&&void 0!==e?e:t.yield_today_entity)&&void 0!==i?i:"",current_consumption_entity:null!==(s=t.current_consumption_entity)&&void 0!==s?s:"",image_url:null!==(o=t.image_url)&&void 0!==o?o:"",show_energy_flow:null!==(n=t.show_energy_flow)&&void 0!==n&&n,show_top_devices:null!==(r=t.show_top_devices)&&void 0!==r&&r,top_devices_max:Math.min(Math.max(parseInt(String(null!==(a=t.top_devices_max)&&void 0!==a?a:4),10)||4,1),8),show_solar_forecast:null!==(l=t.show_solar_forecast)&&void 0!==l&&l,weather_entity:null!==(d=t.weather_entity)&&void 0!==d?d:"",solar_forecast_today_entity:null!==(c=t.solar_forecast_today_entity)&&void 0!==c?c:"",trend_graph_entities:Array.isArray(t.trend_graph_entities)?t.trend_graph_entities:[],yield_today_entity:null!==(h=t.yield_today_entity)&&void 0!==h?h:"",grid_consumption_today_entity:null!==(u=t.grid_consumption_today_entity)&&void 0!==u?u:"",battery_percentage_entity:null!==(p=t.battery_percentage_entity)&&void 0!==p?p:"",inverter_state_entity:null!==(_=t.inverter_state_entity)&&void 0!==_?_:"",total_yield_entity:null!==(v=t.total_yield_entity)&&void 0!==v?v:"",total_grid_consumption_entity:null!==(m=t.total_grid_consumption_entity)&&void 0!==m?m:"",battery_capacity_entity:null!==(y=t.battery_capacity_entity)&&void 0!==y?y:"",inverter_mode_entity:null!==(g=t.inverter_mode_entity)&&void 0!==g?g:""},t);if(!f.production_entity||!f.current_consumption_entity)throw new Error("Solar Card: production_entity and current_consumption_entity are required.");this._config=f,this.requestUpdate()}static getConfigElement(){return document.createElement("solar-card-editor")}static buildCandidateLists(t,e,i){var s;const o=[],n=[],r=new Set,a=(t,e)=>{e&&!r.has(e)&&(t.push(e),r.add(e))},l=e=>{var i,s;if(!e)return;const r=null===(i=null==t?void 0:t.states)||void 0===i?void 0:i[e],l="power"===(null===(s=null==r?void 0:r.attributes)||void 0===s?void 0:s.device_class)?o:n;a(l,e)};for(const t of[e,i])if(Array.isArray(t))for(const e of t)l(e);if(t){const e=Object.values(t.states||{});for(const t of e){const e=t.entity_id;if(!e.startsWith("sensor."))continue;const i="power"===(null===(s=t.attributes)||void 0===s?void 0:s.device_class)?o:n;a(i,e)}}return{power:o,fallback:n}}static getStubConfig(t,e,i){const{power:s,fallback:o}=this.buildCandidateLists(t,e,i);return{type:"custom:solar-card",production_entity:s[0]||o[0]||"sensor.solar_card_stub_production",current_consumption_entity:s[1]||s[0]||o[1]||o[0]||"sensor.solar_card_stub_consumption",image_url:"",show_energy_flow:!1,show_top_devices:!1,top_devices_max:4,show_solar_forecast:!1,weather_entity:"",solar_forecast_today_entity:"",trend_graph_entities:[],yield_today_entity:"",grid_consumption_today_entity:"",battery_percentage_entity:"",inverter_state_entity:"",total_yield_entity:"",total_grid_consumption_entity:"",battery_capacity_entity:"",inverter_mode_entity:""}}set hass(t){var e,i,s,o,n,r;const a=this._hass;if(this._energyFlowEl)try{this._energyFlowEl.hass=t}catch(t){}if(Array.isArray(this._trendGraphEls))for(const e of this._trendGraphEls)try{e.hass=t}catch(t){}if(this._gridKwhEl)try{this._gridKwhEl.hass=t}catch(t){}try{const s=null!==(i=(null===(e=null==t?void 0:t.locale)||void 0===e?void 0:e.language)||(null==t?void 0:t.language))&&void 0!==i?i:null;s&&s!==this._lastLang&&(this._lastLang=s)}catch(t){}const l=this._config||{},d=new Set,c=t=>{t&&d.add(t)};if(c(l.production_entity),c(l.current_consumption_entity),c(l.yield_today_entity),c(l.grid_consumption_today_entity),c(l.battery_percentage_entity),c(l.inverter_state_entity),c(l.total_yield_entity),c(l.total_grid_consumption_entity),c(l.battery_capacity_entity),c(l.inverter_mode_entity),c(l.weather_entity),c(l.solar_forecast_today_entity),Array.isArray(l.trend_graph_entities))for(const t of l.trend_graph_entities)c(t);if(l.show_top_devices&&this._devicePowerMap)for(const t of Object.keys(this._devicePowerMap)){const e=this._devicePowerMap[t]||[];for(const t of e)d.add(t)}let h=!a;if(a&&d.size){for(const e of d)if((null===(s=a.states)||void 0===s?void 0:s[e])!==(null===(o=t.states)||void 0===o?void 0:o[e])){h=!0;break}h||(null===(n=a.locale)||void 0===n?void 0:n.language)===(null===(r=t.locale)||void 0===r?void 0:r.language)||(h=!0)}this._hass=t,l.show_top_devices&&this._maybeRefreshTopDevices(),h&&this.requestUpdate()}get hass(){return this._hass}connectedCallback(){var t;super.connectedCallback(),(null===(t=this._config)||void 0===t?void 0:t.show_top_devices)&&this._maybeRefreshTopDevices()}disconnectedCallback(){super.disconnectedCallback(),this._devicesTimer&&(clearTimeout(this._devicesTimer),this._devicesTimer=null)}_defaultPanelsSvgHtml(){const t=Array.from({length:3}),e=Array.from({length:6}),i=t.flatMap(((t,i)=>e.map(((t,e)=>W`<rect x="${8+31*e}" y="${8+36*i}" width="28" height="28" rx="3" fill="rgba(255,255,255,0.25)" />`))));return I`
    ...
    `}render(){this._hass;const t=this._config||{},e=this._computeOverviewValues(t),i=this._computeTodayPanelValues(t),s=this._computeTotalsPanelValues(t),o=this._computeForecastValues(t),n=t.show_top_devices?this._computeTopDevicesLive(t.top_devices_max||4):[],r=[],a=Array.isArray(t.feature_tiles)?t.feature_tiles:[];for(const t of a)t&&"object"==typeof t&&r.push(Object.assign({type:"tile"},t));const l=[],d=Array.isArray(t.trend_graph_entities)?t.trend_graph_entities.filter((t=>"string"==typeof t&&t.includes("."))):[];l.push(...d);const c=Number(null==t?void 0:t.trend_graph_hours_to_show)||24,h=Number(null==t?void 0:t.trend_graph_detail)||2;for(const t of l)r.push({type:"tile",entity:t,features:[{type:"trend-graph",hours_to_show:c,detail:h}]});return I`
      <ha-card>
        ...
        ${r.length?I`<div id="graphs-section" class="graphs-section"></div>`:q}
        ${t.show_energy_flow?I`<div id="energy-section" class="energy-section"><div id="energy-flow"></div></div>`:q}
      </ha-card>
    `}_computeOverviewValues(t){const e=this._hass;return{production:Pt(e,t.production_entity),consumption:Pt(e,t.current_consumption_entity),image_url:t.image_url||""}}_computeTodayPanelValues(t){var e,i,s,o,n,r;const a=this._hass;let l=Pt(a,t.yield_today_entity),d=Pt(a,t.grid_consumption_today_entity);if((!t.grid_consumption_today_entity||"—"===d.value)&&t.total_grid_consumption_entity){d=this._ensureGridTodayFromTotal(t.total_grid_consumption_entity)||{value:"…",unit:(null===(s=null===(i=null===(e=null==a?void 0:a.states)||void 0===e?void 0:e[t.total_grid_consumption_entity])||void 0===i?void 0:i.attributes)||void 0===s?void 0:s.unit_of_measurement)||""}}if((!t.yield_today_entity||"—"===l.value)&&t.total_yield_entity){l=this._ensureYieldTodayFromTotal(t.total_yield_entity)||{value:"…",unit:(null===(r=null===(n=null===(o=null==a?void 0:a.states)||void 0===o?void 0:o[t.total_yield_entity])||void 0===n?void 0:n.attributes)||void 0===r?void 0:r.unit_of_measurement)||""}}return{yieldToday:l,gridToday:d,batteryPct:Pt(a,t.battery_percentage_entity),inverterState:Pt(a,t.inverter_state_entity)}}_computeTotalsPanelValues(t){const e=this._hass;return{totalYield:Pt(e,t.total_yield_entity),totalGrid:Pt(e,t.total_grid_consumption_entity),batteryCapacity:Pt(e,t.battery_capacity_entity),inverterModeDisplay:Pt(e,t.inverter_mode_entity)}}_computeForecastValues(t){const e=this._hass,i=this._weatherDisplay(e,t.weather_entity),s=Pt(e,t.solar_forecast_today_entity),o=!!t.weather_entity,n=!!t.solar_forecast_today_entity||!o;return{title:At(o?"card.weather_today":"card.solar_forecast"),icon:o?i.icon||"mdi:weather-partly-cloudy":"mdi:white-balance-sunny",majorValue:n?`${s.value}`:`${null!=i.temperature?i.temperature:"—"}`,majorUnit:n?`${s.unit}`:`${i.unit||""}`,minor:n?At("card.expected_forecast"):i.condition||""}}_renderOverviewPanel(t,e,i){return I` <div class="overview-panel">
      <div class="content">
        <div class="metric">
          <div class="label"><ha-icon icon="mdi:solar-panel"></ha-icon> ${At("card.production")}</div>
          <div class="value">${t.value} ${t.unit}</div>
        </div>
        <div class="metric">
          <div class="label"><ha-icon icon="mdi:power-socket-eu"></ha-icon> ${At("card.consumption")}</div>
          <div class="value smaller">${e.value} ${e.unit}</div>
        </div>
      </div>
      <div class="image">
        ${i?I`<img src="${i}" alt="Solar panels" loading="lazy" />`:this._defaultPanelsSvgHtml()}
      </div>
    </div>`}_renderTodayPanel(t,e){const i=!(!t.yield_today_entity&&!t.total_yield_entity),s=!(!t.grid_consumption_today_entity&&!t.total_grid_consumption_entity),o=!!t.battery_percentage_entity,n=!!t.inverter_state_entity,r=[];return i&&r.push(I`<div class="metric metric-top">
          <ha-icon class="icon" icon="mdi:solar-power-variant"></ha-icon>
          <div class="label">${At("card.yield_today")}</div>
          <div class="value smaller">${e.yieldToday.value} ${e.yieldToday.unit}</div>
        </div>`),s&&r.push(I`<div class="metric metric-top">
          <ha-icon class="icon" icon="mdi:transmission-tower"></ha-icon>
          <div class="label">${At("card.grid_today")}</div>
          <div class="value smaller">${e.gridToday.value} ${e.gridToday.unit}</div>
        </div>`),o&&r.push(I`<div class="metric metric-top">
          <ha-icon class="icon" icon="mdi:battery"></ha-icon>
          <div class="label">${At("card.battery")}</div>
          <div class="value smaller">${e.batteryPct.value} ${e.batteryPct.unit||"%"}</div>
        </div>`),n&&r.push(I`<div class="metric metric-top">
          <ha-icon class="icon" icon="mdi:power"></ha-icon>
          <div class="label">${At("card.inverter_state")}</div>
          <div class="value smaller">${e.inverterState.value}</div>
        </div>`),r.length?I` <div class="today-panel metrics-grid" style="--metrics-cols: ${r.length}">${r}</div>`:q}_renderTotalsPanel(t,e){const i=[];return t.total_yield_entity&&i.push(I`<div class="metric metric-bottom">
          <div class="label">${At("card.total_yield")}</div>
          <div class="value smaller">${e.totalYield.value} ${e.totalYield.unit}</div>
        </div>`),t.total_grid_consumption_entity&&i.push(I`<div class="metric metric-bottom">
          <div class="label">${At("card.grid_consumption")}</div>
          <div class="value smaller">${e.totalGrid.value} ${e.totalGrid.unit}</div>
        </div>`),t.battery_capacity_entity&&i.push(I`<div class="metric metric-bottom">
          <div class="label">${At("card.battery_capacity")}</div>
          <div class="value smaller">${e.batteryCapacity.value} ${e.batteryCapacity.unit}</div>
        </div>`),t.inverter_mode_entity&&i.push(I`<div class="metric metric-bottom">
          <div class="label">${At("card.inverter_mode")}</div>
          <div class="value smaller">${e.inverterModeDisplay.value}</div>
        </div>`),i.length?I` <div class="totals-panel metrics-grid" style="--metrics-cols: ${i.length}">${i}</div>`:q}_renderForecastPanel(t){return I` <div class="forecast-panel">
  ...
  `,customElements.define("solar-card",Rt);
